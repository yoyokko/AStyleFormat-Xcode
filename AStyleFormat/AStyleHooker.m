...
+ (void) hookClass:(NSString *) cls method:(NSString *) mtd byClass:(NSString *) cls2 method:(NSString *) mtd2
{
    ...
    SEL preservedSelector = [AStyleHooker createPreserveSelectorName:mtd];
    
    [AStyleHooker hookMethod:NSSelectorFromString(mtd) ofClass:c1 withMethod:m2 keepingOriginalWith:preservedSelector];
}
...
+ (void) unhookClass:(NSString *) cls method:(NSString *) mtd
{
    ...
    [AStyleHooker hookMethod:NSSelectorFromString(mtd) ofClass:c1 withMethod:m2 keepingOriginalWith:nil];
}
